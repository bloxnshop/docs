...
<Columns cols={1}>
  <Card title="Staff Information" icon="clipboard-user" href="/staffinformation/staff-code-of-conduct">
    Information for staff members of BloxNShop.
  </Card>
  <Card title="FAQ" icon="question" href="/faq">
    Frequently Asked Questions
  </Card>
  <Card title="Contacts" icon="phone" href="/contacts">
    Contact us!
  </Card>
</Columns>
...
<HeroCard
    ...
    description="Information for staff members of BloxNShop."
